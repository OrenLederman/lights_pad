...
void setup()
{
  /****** Setup timer1 as inactivity timer *****/
  cli();//stop interrupts
...
// Interrupt is called once a second. Increase inactivity seconds count
...
void changeEffect() {
  // reset activity. Actually - no need. We are going to restart the arduino anyway
  // inactivity_sec = 0;
